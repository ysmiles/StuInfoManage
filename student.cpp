...
void student::sName(string name)
{
	stuname=name;
}
void student::sSex(int s)
{
	sex=s;
}
...
void teacher::sName(string name)
{
	teaname=name;
}
void teacher::sSex(int s)
{
	sex=s;
}
void teacher::sTeach(string t)
{
	teach=t;
}
...
int topstu::getMoney()
{
	if(getTotal()<=250) money=1000;
	else if(getTotal()>279) money=3000;
	else money=2000;
	return money;
}
